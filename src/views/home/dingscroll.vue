<template>
  <div class="main-conteiner" ref="mainConteiner" @scroll="updatestyles">
...
function updateMap() {
  ...
  const scrollStart = playGroundRect.top + mainConteiner.value?.scrollTop;
  const scrollEnd = playGroundRect.bottom + mainConteiner.value?.scrollTop - window.innerHeight;
...
function updatestyles() {
  const scrollY = mainConteiner.value?.scrollTop || 0;
